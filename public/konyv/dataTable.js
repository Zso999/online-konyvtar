...
(function(f) {
  ...
  function Ga(a) {
    ...
    if (a) {
      ...
      !a.sEmptyTable &&
        d &&
        "Nincs elérhető könyv" === b.sEmptyTable &&
        M(a, a, "sZeroRecords", "sEmptyTable");
      !a.sLoadingRecords &&
        d &&
        "Betöltés..." === b.sLoadingRecords &&
  ...
  q.defaults = {
    ...
    oLanguage: {
      oAria: {
        sSortAscending: ": oszlop szerint növekvő sorrend",
        sSortDescending: ": oszlop szerint csökkenő sorrend"
      },
      oPaginate: {
        sFirst: "Első",
        sLast: "Utolsó",
      ...
      sEmptyTable: "Nincs elérhető könyv",
      sInfo: " _START_-tól/től _END_-ig _TOTAL_ könyvből",
      sInfoEmpty: "0-tól/től 0-ig 0 könyvből",
      sInfoFiltered: "(szűrve az összesen _MAX_ könyvből)",
      sInfoPostFix: "",
      sDecimal: "",
      sThousands: ",",
      sLengthMenu: "Mutass _MENU_ könyvet",
